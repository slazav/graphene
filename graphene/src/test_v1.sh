...
assert "$($prog get_prev tab1 1234567891.500)" "1234567891 1"
assert "$($prog get_prev tab2 1234567891.500)" "1234567891 0.1"
assert "$($prog get_prev tab3 1234567891.500)" "1234567891 text 2"
...
assert "$($prog get tab1 1234567890.500)" "1234567890 0"
assert "$($prog get tab2 1234567890.500)" "1234567890.500 0.05"
assert "$($prog get tab3 1234567890.500)" "1234567890 text 1"
